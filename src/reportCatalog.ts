...
export const DEFAULT_REPORT_CATEGORIES: ReportCategory[] = [
  ...
  defaultCategory('winbackMag25', 'Winback', 'priority', 'phone', 'text-blue-600', 140),
  defaultCategory('scegliAllianzGen26', 'ScegliAllianz', 'priority', 'phone', 'text-indigo-600', 150),
